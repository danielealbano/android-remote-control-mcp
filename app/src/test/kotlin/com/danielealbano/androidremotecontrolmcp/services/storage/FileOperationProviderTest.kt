...
class FileOperationProviderTest {
    ...
    fun setUp() {
        ...
        provider = FileOperationProviderImpl(
            mockContext,
    ...
    inner class ListFiles {
        ...
        @Test
        fun `listFiles returns entries for authorized location`() = runTest {
            // Arrange
            ...
            val dirChild = mockk<DocumentFile> {
            ...
            val fileChild = mockk<DocumentFile> {
        ...
        @Test
        fun `listFiles throws PermissionDenied for unauthorized location`() = runTest {
            // Arrange
            setupUnauthorizedLocation("loc1")

            // Act & Assert
            val exception = assertThrows<McpToolException.PermissionDenied> {
        ...
        @Test
        fun `listFiles respects offset and limit`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockDir = mockk<DocumentFile>()
            setupRootDocument(mockDir)
        ...
        @Test
        fun `listFiles caps limit at MAX_LIST_ENTRIES`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockDir = mockk<DocumentFile>()
            setupRootDocument(mockDir)
            ...
            val children = (1..LIST_ENTRIES_ABOVE_MAX).map { i ->
                mockk<DocumentFile> {
    ...
    inner class ReadFile {
        ...
        @Test
        fun `readFile returns lines with pagination info`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
        ...
        @Test
        fun `readFile caps limit at MAX_READ_LINES`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockRootDoc = mockk<DocumentFile>()
            setupRootDocument(mockRootDoc)
        ...
        @Test
        fun `readFile includes hasMore hint when more lines exist`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockRootDoc = mockk<DocumentFile>()
            setupRootDocument(mockRootDoc)
        ...
        @Test
        fun `readFile throws PermissionDenied for unauthorized location`() = runTest {
            // Arrange
            setupUnauthorizedLocation("loc1")
        ...
        @Test
        fun `readFile throws ActionFailed when file exceeds size limit`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockRootDoc = mockk<DocumentFile>()
            setupRootDocument(mockRootDoc)
            ...
            val exception = assertThrows<McpToolException.ActionFailed> {
    ...
    inner class WriteFile {
        ...
        @Test
        fun `writeFile creates file with content`() = runTest {
            // Arrange
            coEvery { mockSettingsRepository.getServerConfig() } returns
                ServerConfig(fileSizeLimitMb = DEFAULT_FILE_SIZE_LIMIT_MB)
            setupAuthorizedLocation("loc1")
        ...
        @Test
        fun `writeFile with empty content creates empty file`() = runTest {
            // Arrange
            coEvery { mockSettingsRepository.getServerConfig() } returns
                ServerConfig(fileSizeLimitMb = DEFAULT_FILE_SIZE_LIMIT_MB)
            setupAuthorizedLocation("loc1")
        ...
        @Test
        fun `writeFile throws ActionFailed when content exceeds size limit`() = runTest {
    ...
    inner class AppendFile {
        ...
        @Test
        fun `appendFile throws ActionFailed when resulting size exceeds limit`() = runTest {
    ...
    inner class ReplaceInFile {
        ...
        @Test
        fun `replaceInFile replaces first occurrence`() = runTest {
            // Arrange
            val outputStream = setupReplaceFile("hello world hello")

            // Act
            val result = provider.replaceInFile(
                "loc1", "file.txt", "hello", "hi", false,
            )
        ...
        @Test
        fun `replaceInFile replaces all occurrences when replaceAll is true`() = runTest {
            // Arrange
            val outputStream = setupReplaceFile("hello world hello")

            // Act
            val result = provider.replaceInFile(
                "loc1", "file.txt", "hello", "hi", true,
            )
        ...
        @Test
        fun `replaceInFile returns zero count when old_string not found`() = runTest {
            // Arrange
            setupReplaceFile("hello world")

            // Act
            val result = provider.replaceInFile(
                "loc1", "file.txt", "xyz", "abc", false,
            )
        ...
        @Test
        fun `replaceInFile throws ActionFailed when file exceeds size limit`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockRootDoc = mockk<DocumentFile>()
            setupRootDocument(mockRootDoc)
    ...
    inner class DeleteFile {
        ...
        @Test
        fun `deleteFile deletes the file`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockRootDoc = mockk<DocumentFile>()
            setupRootDocument(mockRootDoc)
        ...
        @Test
        fun `deleteFile throws ActionFailed when path is a directory`() = runTest {
            // Arrange
            setupAuthorizedLocation("loc1")
            val mockRootDoc = mockk<DocumentFile>()
            setupRootDocument(mockRootDoc)
